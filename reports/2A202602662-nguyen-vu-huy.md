...
- Repository/branch: https://github.com/tsun165/K4-L3A-RAG-Pipeline — nhánh `feature/tv2-retrieval`, đã merge vào `main` tại commit `2011cec`
...
| Chạy với bge-m3 thật | Index thật để lấy cosine score thực tế cho TV3 hiệu chỉnh threshold. Download model 2,27 GB bị nghẽn ở đường mạng (~0,1 MB/s/kết nối, đo lúc 15:30); đã viết downloader song song có resume và đang tải nền, số liệu sẽ bổ sung khi có | scratchpad, chưa commit | Partial |
